...
function setup() 
{
  ...
  emptyStars = createSprite(80, 30, 50, 50);
  emptyStars.scale = 0.3
  emptyStars.addAnimation('empty', emptystars);
  emptyStars.addAnimation('one', onestar);
  emptyStars.addAnimation('two', twostars);
  emptyStars.changeAnimation('empty');
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit, star1) == true && star1.visible == true) {
     star1.visible = false;
     starsCollected = starsCollected + 1;
   }

   if (collide(fruit, star2) == true && star2.visible == true) {
    star2.visible = false;
    starsCollected = starsCollected + 1;
   }
   drawStars();
...
function drawStars () {
  ...
  if (starsCollected == 1) {
    emptyStars.changeAnimation('one');
    return;
  }
  
  if (starsCollected == 2) {
    emptyStars.changeAnimation('two');
    return;
  }
}